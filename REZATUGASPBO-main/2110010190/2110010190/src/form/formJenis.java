...
public class formJenis extends javax.swing.JFrame {
    ...
    private datasetjenis datajenis;

    public formJenis() {
        initComponents();
        datajenis = new datasetjenis();
                            ...
                            .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                                ...
                                .addGroup(layout.createSequentialGroup()
                                    ...
                                    .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                                        ...
                                        .addComponent(txtIndex, javax.swing.GroupLayout.DEFAULT_SIZE, 110, Short.MAX_VALUE))))))
                    .addGroup(layout.createSequentialGroup()
                        .addGap(31, 31, 31)
    ...
    private void btnTambahDataActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnTambahDataActionPerformed
        datajenis.insertid_jenis(Integer.valueOf(txtIdJenis.getText()));
        datajenis.insertNama_jenis(txtNamaJenis.getText());
    ...
    private void btnBacaDataActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnBacaDataActionPerformed
        ...
        String isiData = "Nama : " + datajenis.getRecordid_jenis().get(i)
                    + "Nama Jenis : " + datajenis.getNama_jenis().get(i);
